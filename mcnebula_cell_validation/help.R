...
## ------------------------------------- 
# source("~/outline/mcnebula_cell_validation/export.extra3_biomarker.R")
# source("~/outline/mcnebula_cell_validation/export.extra4_gt.R")
# export.extra5_syno
## ---------------------------------------------------------------------- 
## get CID
